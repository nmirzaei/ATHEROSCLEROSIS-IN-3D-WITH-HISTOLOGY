...
theta = sym.atan2(y,x)
t = theta + pi
r_1 = (0.578244)+(-0.372715)*sym.cos(t)+(0.034017)*sym.cos(2*t)+(0.011333)*sym.cos(3*t)+(0.006484)*sym.cos(4*t)+(-0.005619)*sym.cos(5*t)+(-0.004827)*sym.cos(6*t)+(0.004946)*sym.cos(7*t)+(0.000575)*sym.cos(8*t)+(0.003674)*sym.sin(t)+(-0.023116)*sym.sin(2*t)+(0.012197)*sym.sin(3*t)+(0.005207)*sym.sin(4*t)+(0.004428)*sym.sin(5*t)+(0.002318)*sym.sin(6*t)+(-0.005940)*sym.sin(7*t)+(0.004274)*sym.sin(8*t)
r_2 = (1.042974)+(-0.058644)*sym.cos(t)+(0.001808)*sym.cos(2*t)+(-0.013822)*sym.cos(3*t)+(0.003230)*sym.cos(4*t)+(-0.006332)*sym.cos(5*t)+(-0.003010)*sym.cos(6*t)+(0.000307)*sym.cos(7*t)+(0.001640)*sym.cos(8*t)+(-0.031070)*sym.sin(t)+(-0.000964)*sym.sin(2*t)+(-0.003722)*sym.sin(3*t)+(-0.007314)*sym.sin(4*t)+(0.001668)*sym.sin(5*t)+(-0.001127)*sym.sin(6*t)+(0.005961)*sym.sin(7*t)+(0.004657)*sym.sin(8*t)
f_1_x = (r_1)*sym.cos(t)
f_1_y = (r_1)*sym.sin(t)
f_2_x = (r_2)*sym.cos(t)
f_2_y = (r_2)*sym.sin(t)
...
r_3 = (1.242974)+(-0.058644)*sym.cos(t)+(0.001808)*sym.cos(2*t)+(-0.013822)*sym.cos(3*t)+(0.003230)*sym.cos(4*t)+(-0.006332)*sym.cos(5*t)+(-0.003010)*sym.cos(6*t)+(0.000307)*sym.cos(7*t)+(0.001640)*sym.cos(8*t)+(-0.031070)*sym.sin(t)+(-0.000964)*sym.sin(2*t)+(-0.003722)*sym.sin(3*t)+(-0.007314)*sym.sin(4*t)+(0.001668)*sym.sin(5*t)+(-0.001127)*sym.sin(6*t)+(0.005961)*sym.sin(7*t)+(0.004657)*sym.sin(8*t)
f_2_x = (r_2)*sym.cos(t)
f_2_y = (r_2)*sym.sin(t)
f_3_x = (r_3)*sym.cos(t)
f_3_y = (r_3)*sym.sin(t)
...
r_4 = (1.342974)+(-0.058644)*sym.cos(t)+(0.001808)*sym.cos(2*t)+(-0.013822)*sym.cos(3*t)+(0.003230)*sym.cos(4*t)+(-0.006332)*sym.cos(5*t)+(-0.003010)*sym.cos(6*t)+(0.000307)*sym.cos(7*t)+(0.001640)*sym.cos(8*t)+(-0.031070)*sym.sin(t)+(-0.000964)*sym.sin(2*t)+(-0.003722)*sym.sin(3*t)+(-0.007314)*sym.sin(4*t)+(0.001668)*sym.sin(5*t)+(-0.001127)*sym.sin(6*t)+(0.005961)*sym.sin(7*t)+(0.004657)*sym.sin(8*t)
f_4_x = (r_4)*sym.cos(t)
f_4_y = (r_4)*sym.sin(t)
...
vtkfile2 = File('E_2D/LDL.pvd')
vtkfile3 = File('E_2D/Macrophage.pvd')
vtkfile4 = File('E_2D/Deadcells.pvd')
vtkfile5 = File('E_2D/oxygen.pvd')
vtkfile6 = File('E_2D/MCP.pvd')
vtkfile7 = File('E_2D/PDGF1.pvd')
vtkfile8 = File('E_2D/PDGF2.pvd')
volumefile1 = File('E_2D/Volume_intima.pvd')
volumefile2 = File('E_2D/Volume_artery.pvd')
test1 = File('E_2D/g_i_test.pvd')
###############################################################
...
while t<=t_max:
     ...
     if sigma>sigmax:
          ...
          File("E_2D/displacement/u%d.xml" %(counter))<<u
          counter+=1
          if k%10==0:
